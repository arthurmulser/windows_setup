...
20:25:43	CREATE TABLE `tb_turnos_eventos` (   `idtb_turnos_eventos` bigint unsigned NOT NULL AUTO_INCREMENT,   `id_estrangeiro` bigint unsigned DEFAULT NULL,   `idtb_entidades` bigint unsigned NOT NULL,   `idtb_turnos` bigint unsigned NOT NULL,   `idtb_turnos_tipos` bigint unsigned NOT NULL,   `identificador_os` varchar(128) DEFAULT NULL,   `nome_foto` varchar(128) DEFAULT NULL,   `obs` varchar(256) DEFAULT NULL,   `uniq_evento` varchar(128) NOT NULL,   `latitude` decimal(10,8) NOT NULL,   `longitude` decimal(11,8) NOT NULL,   `quantidade` decimal(10,3) DEFAULT NULL,   `dt_evento` datetime NOT NULL,   `idtb_ativo` tinyint(1) NOT NULL DEFAULT '1',   `dt_insert` datetime NOT NULL,   `login_insert` varchar(64) NOT NULL,   `dt_update` datetime DEFAULT NULL,   `login_update` varchar(64) DEFAULT NULL,   PRIMARY KEY (`idtb_turnos_eventos`),   UNIQUE KEY `tb_turnos_eventos_uniq_evento_unique` (`uniq_evento`),   KEY `tb_turnos_eventos_id_estrangeiro_index` (`id_estrangeiro`),   KEY `tb_turnos_eventos_idtb_entidades_index` (`idtb_entidades`),   KEY `tb_turnos_eventos_idtb_turnos_index` (`idtb_turnos`),   KEY `tb_turnos_eventos_idtb_turnos_tipos_index` (`idtb_turnos_tipos`),   CONSTRAINT `tb_turnos_eventos_idtb_entidades_foreign` FOREIGN KEY (`idtb_entidades`) REFERENCES `tb_entidades` (`idtb_entidades`) ON DELETE RESTRICT,   CONSTRAINT `tb_turnos_eventos_idtb_turnos_foreign` FOREIGN KEY (`idtb_turnos`) REFERENCES `tb_turnos` (`idtb_turnos`) ON DELETE RESTRICT,   CONSTRAINT `tb_turnos_eventos_idtb_turnos_tipos_foreign` FOREIGN KEY (`idtb_turnos_tipos`) REFERENCES `tb_turnos_tipos` (`idtb_turnos_tipos`) ON DELETE RESTRICT ) ENGINE=InnoDB	0 row(s) affected, 1 warning(s): 1681 Integer display width is deprecated and will be removed in a future release.	0.203 sec

20:24:31	CREATE TABLE `tb_turnos_eventos_tipos` (   `idtb_turnos_eventos_tipos` bigint unsigned NOT NULL AUTO_INCREMENT,   `nome` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,   `idtb_ativo` tinyint(1) NOT NULL DEFAULT '1',   `dt_insert` datetime NOT NULL,   `login_insert` varchar(64) NOT NULL,   `dt_update` datetime DEFAULT NULL,   `login_update` varchar(64) DEFAULT NULL,   PRIMARY KEY (`idtb_turnos_eventos_tipos`),   UNIQUE KEY `tb_turnos_eventos_tipos_nome_unique` (`nome`) ) ENGINE=InnoDB	0 row(s) affected, 1 warning(s): 1681 Integer display width is deprecated and will be removed in a future release.	0.196 sec

09:46:01	truncate tb_formularios_perguntas	0 row(s) affected	0.303 sec

09:38:51	UPDATE tb_perguntas  SET      idtb_perguntas_tipos = 4	29 row(s) affected Rows matched: 29  Changed: 29  Warnings: 0	0.176 sec

15:40:54	CREATE TABLE `tb_formularios_perguntas` (   `idtb_formularios_perguntas` bigint unsigned NOT NULL AUTO_INCREMENT,   `idtb_formularios` bigint unsigned NOT NULL,   `idtb_perguntas` bigint unsigned NOT NULL,   `obs` varchar(1024) DEFAULT NULL,   `uniq_formulario_pergunta` varchar(32) GENERATED ALWAYS AS (if((`idtb_ativo` = 1),concat(`idtb_formularios`,_utf8mb4'_',`idtb_perguntas`),NULL)) VIRTUAL,   `ordem` decimal(8,2) DEFAULT NULL,   `peso` int DEFAULT NULL,   `quantidade_minima` int DEFAULT NULL,   `aceita_nao_se_aplica` tinyint(1) DEFAULT NULL,   `resposta_esperada` int DEFAULT NULL,   `idtb_ativo` tinyint(1) NOT NULL DEFAULT '1',   `dt_insert` datetime NOT NULL,   `login_insert` varchar(64) NOT NULL,   `dt_update` datetime DEFAULT NULL,   `login_update` varchar(64) DEFAULT NULL,   PRIMARY KEY (`idtb_formularios_perguntas`),   UNIQUE KEY `tb_formularios_perguntas_uniq_formulario_pergunta_unique` (`uniq_formulario_pergunta`),   KEY `tb_formularios_perguntas_idtb_formularios_foreign` (`idtb_formularios`),   KEY `tb_formularios_perguntas_idtb_perguntas_foreign` (`idtb_perguntas`),   CONSTRAINT `tb_formularios_perguntas_idtb_formularios_foreign` FOREIGN KEY (`idtb_formularios`) REFERENCES `tb_formularios` (`idtb_formularios`) ON DELETE RESTRICT,   CONSTRAINT `tb_formularios_perguntas_idtb_perguntas_foreign` FOREIGN KEY (`idtb_perguntas`) REFERENCES `tb_perguntas` (`idtb_perguntas`) ON DELETE RESTRICT ) ENGINE=InnoDB	0 row(s) affected, 2 warning(s): 1681 Integer display width is deprecated and will be removed in a future release. 1681 Integer display width is deprecated and will be removed in a future release.	0.174 sec

20:49:15	INSERT INTO `tb_perguntas`     (`idtb_perguntas_grupos`, `idtb_perguntas_tipos`, `pergunta`, `idtb_ativo`, `dt_insert`, `login_insert`) VALUES     ('1', '2', 'ÁGUA DE ARREFECIMENTO', '1', NOW(), 'admin'),     ('1', '2', 'ALARME DE RÉ', '1', NOW(), 'admin'),     ('1', '2', 'BUZINA', '1', NOW(), 'admin'),     ('1', '2', 'CATRACA DE AMARRAÇÃO DE ESCADA', '1', NOW(), 'admin'),     ('1', '2', 'CHAVE DE RODA', '1', NOW(), 'admin'),     ('1', '2', 'CINTO DE SEGURANÇA', '1', NOW(), 'admin'),     ('1', '2', 'CONDIÇÕES DA CARROCERIA (ASSOALHO)', '1', NOW(), 'admin'),     ('1', '2', 'ESCADA DE ACESSO À CARROCERIA', '1', NOW(), 'admin'),     ('1', '2', 'ESPELHO RETROVISOR EXTERNO', '1', NOW(), 'admin'),     ('1', '2', 'ESPELHO RETROVISOR INTERNO', '1', NOW(), 'admin'),     ('1', '2', 'EXTINTOR DE INCÊNDIO DA CABINE AUXILIAR', '1', NOW(), 'admin'),     ('1', '2', 'EXTINTOR DE INCÊNDIO DA CABINE PRINCIPAL', '1', NOW(), 'admin'),     ('1', '2', 'FARÓIS', '1', NOW(), 'admin'),     ('1', '2', 'FREIO', '1', NOW(), 'admin'),     ('1', '2', 'FREIO DE MÃO', '1', NOW(), 'admin'),     ('1', '2', 'LANTERNAS', '1', NOW(), 'admin'),     ('1', '2', 'LATARIA E PINTURA', '1', NOW(), 'admin'),     ('1', '2', 'LIMPADOR DE PARA-BRISA', '1', NOW(), 'admin'),     ('1', '2', 'LUZ DE FREIO', '1', NOW(), 'admin'),     ('1', '2', 'LUZ DE RÉ', '1', NOW(), 'admin'),     ('1', '2', 'MACACO', '1', NOW(), 'admin'),     ('1', '2', 'MALLHAU COM BORRACHAS', '1', NOW(), 'admin'),     ('1', '2', 'NÍVEL DE ÓLEO DE FREIO', '1', NOW(), 'admin'),     ('1', '2', 'NÍVEL DE ÓLEO DO MOTOR', '1', NOW(), 'admin'),     ('1', '2', 'PISCA-ALERTA', '1', NOW(), 'admin'),     ('1', '2', 'PNEUS E ESTEPE', '1', NOW(), 'admin'),     ('1', '2', 'PORTA-ESCADA', '1', NOW(), 'admin'),     ('1', '2', 'SETAS', '1', NOW(), 'admin'),     ('1', '2', 'TRIÂNGULO DE SINALIZAÇÃO', '1', NOW(), 'admin')	29 row(s) affected Records: 29  Duplicates: 0  Warnings: 0	0.204 sec
